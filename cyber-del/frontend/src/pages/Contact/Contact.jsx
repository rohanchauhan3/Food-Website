  ...
  return (
    <div className='contact'>
      ...
      <p>Feel free to reach out through contact form or find our contact
        ...
        important to us.</p>
        <ul>
          <li><img src={mail_icon} alt="" />Contact@Cybercrave.gmail</li>
          <li><img src={phone_icon} alt="" />+91-9510212518</li>
          <li><img src={location_icon} alt="" />380015 Shyamal crossroads, Shyamal<br/>Ahmedabad, Gujrat 
          India</li>
        </ul>
      </div>
      <div className="contact-col">
